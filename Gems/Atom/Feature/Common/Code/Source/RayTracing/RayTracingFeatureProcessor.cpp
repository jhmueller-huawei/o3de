    ...
    namespace Render
    {
        ...
        void RayTracingFeatureProcessor::UpdateMaterialInfoBuffer()
        {
            if (m_materialInfoBufferNeedsUpdate)
            {
                ...
                uint64_t proceduralMaterialInfoByteCount = m_proceduralGeometry.size() * sizeof(MaterialInfo);
                ...
                currentMaterialInfoGpuBuffer->UpdateData(rawData, proceduralMaterialInfoByteCount, meshMaterialInfoByteCount);
